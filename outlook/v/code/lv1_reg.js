    ...
    *get_subscription_data(roles) {
    ...
    async get_business() {
        ...
        if (pk === '0') {
            //
            //Get the id .
            const id = this.get_input_value('id', 'yes', 'throw');
            //
            //Get the name.
            const name = this.get_input_value('name', 'yes', 'throw');
            //
    ...
    async get_business_info(pk) {
        ...
        const business_id = await this.exec_php('database', [this.user_dbname], 'get_sql_data', [sql]);
        //
        //return the result.
...
class register_business extends popup {
    ...
    async check() {
        ...
        const name = this.get_input_value("name", 'yes', 'return');
        //
        //Get and check the business_id from the business
        const id = this.get_input_value("id", 'yes', 'return');
        //
