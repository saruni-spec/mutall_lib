import { panel } from "./outlook.js";
//
import { database, mutall_error } from "../../../schema/v/code/schema.js";
//
...
export class theme extends panel {
    ...
    async load_body(offset /*:int*/, dir /*:mytop | bottom*/) {
        ...
        if (this.within_view(offset))
            throw new mutall_error(`The requested offset ${offset} 
                is already in view 
    ...
    async query(offset, limit) {
        ...
        return await this.exec_php("database", 
        //
