...
Concepts
    -without any hidding tabulators
*/
...
window.onload = async () => {
    ...
    const performance = (() => {
        ...
        //
        //Create the homozone and hide its 0 axis
        return new homozone(ds, { axes: [{ hidden: true }, undefined] });
    })();
    //
    //
