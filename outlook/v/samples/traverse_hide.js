...
window.onload = async () => {
    ...
    'path', 
    //
    //The constructor parameters. NB. The path is relative, so we require
    ...
    const col = 'subject';
    //
    //There will be 2 homozones -- score and value -- driven by the same query
    const score = (() => {
        //
        ...
        //
        //Hide the axis on the 1 dimension
        const axes = [undefined, { hidden: true }];
        //
        //Create a hidden zone of percent scores, hiding the horizontal axis
        const zone = new homozone(ds, { class_name: 'score_score', axes });
        //
        return zone;
    })();
    //    
