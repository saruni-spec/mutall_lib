...
export class select extends io {
    ...
    get listener() { return this.input; }
    // 
    constructor(anchor, 
    // 
...
export class foreign extends io {
    ...
    get listener() { return this.button; }
    //
...
export class input extends io {
    ...
    get_size() {
        ...
        if (this.io_options?.size)
            return this.io_options.size;
        //
        //If the maximumn number of chateters is provided, use it as the size
        if (this.io_options?.maxlength)
            return this.io_options.maxlength;
    }
...
export class primary extends io {
    ...
    update_outputs() {
        ...
        if (this.show_values) {
            ...
            const str = this.input ? this.input.value : this.output.textContent;
            //
            this.output.textContent = str;
        }
    }
