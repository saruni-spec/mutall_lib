...
class merger extends schema{
    ...
    public string $cname;
    //
    //The database holding the records to merge
   ...
   function __construct(stdClass $Imerge) {
    ...
    public function get_column_query(column $col):string{
        //
        //
        $sql = $this->dbase->chk(
            "select "
    ...
    public function get_pointers(): array /*<pointer>*/{
        //
    ...
    */
    public function get_indices(stdClass $pointer):array/*<index>*/{
        //
    ...
    public function get_member_sql(database $dbase, string $signature, stdClass $pointer):string/*sql*/{
        //
    ...
    public function get_signatures(database $dbase, string $signature, string /*sql*/ $members):array/*<signature>*/{
        //
