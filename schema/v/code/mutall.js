export class mutall {
    ...
    static merge(a, b) {
        ...
        if (!a && b)
            return { type: 'merged', value: b };
        //
        //If b is not defined, and a is defined, retirn a
        if (!b && a)
            return { type: 'merged', value: a };
        //
        ...
        if (a && b && a !== b)
            return { type: 'difference', values: [a, b] };
        //
     ...
     */
    static arrays_are_equal(arr1, arr2) {
        //
...
export class mymap extends Map {
    ...
    constructor(descriptor, iterable) {
        super(iterable);
...
export function myalert(message, ...extra) {
    //
