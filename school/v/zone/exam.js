...
export class exam extends view {
    ...
    get_sitting_heterozone() {
        ...
        this.sitting_homo = (() => {
            ...
            const ds = { type: 'sql.long', sql, row, col, basic_value, dbname };
            //
            ...
            const options = {
                ...
                onclick: async (cell) => await this.onclick_sitting()
            };
            //
    ...
    get_score_heterozone() {
        ...
        this.score_homo = (() => {
            ...
            const col = 'performance.performance';
            //
        ...
        const summary_right = (() => {
            ...
            const options = { driver_source: ds };
            //
            return new homozone(options);
        })();
        //
    ...
    onchange_basic_value() {
        ...
        //
        const score = this.get_score_heterozone();
        //
